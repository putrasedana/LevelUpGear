  ...
  return (
    <Card className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl">
      <CardHeader className="flex flex-row items-center space-y-0 pb-4">
        ...
        <CardTitle className="text-xl font-bold text-white">Related Videos</CardTitle>
      </CardHeader>
      <CardContent>
        {review.videoIds && review.videoIds.length > 0 ? (
          ...
          <p className="text-gray-400 text-center py-8">No related videos available.</p>
        )}
      </CardContent>
    </Card>
  );
