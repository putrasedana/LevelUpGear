...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 group hover:border-purple-500/50 transition-all duration-300 hover:bg-gray-800/70 flex flex-col justify-between">
      {/* Card content (top) */}
      <div className="flex-1">
        <div className="aspect-auto bg-gray-700/50 rounded-lg mb-4 overflow-hidden">
          <img
            src={image}
            alt={name}
      ...
      {/* Price + Button section (always at bottom, aligned across cards) */}
